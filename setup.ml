...
(* OASIS_START *)
(* DO NOT EDIT (digest: 15cf70f7a903ffa0fd7dfaa3ba2c5e66) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/dominicjprice/facebook-sdk";
          synopsis = "Facebook Graph API SDK for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "OCaml bindings to the Facebook graph API using cohttp and lwt threading. This package is still in the early stages of development and at present only contains the functionality required to fetch a user's time-line and to publish simple messages to the time-line."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Common"; "User"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "facebook";
                      lib_findlib_name = Some "endpoints";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Api"; "Auth"; "Request"; "Request_cohttp"; "Util"];
                      lib_pack = true;
                      lib_internal_modules = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "feed_example.ml"});
               Executable
                 ({
                     cs_name = "friend_list_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "friend_list_example.ml"
                   });
               Doc
                 ({
                     cs_name = "facebook";
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/facebook-sdk";
                      doc_title = "Facebook-SDK API Reference";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/facebook-sdk.git";
                      src_repo_browser =
                        Some "https://github.com/dominicjprice/facebook-sdk";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\004*\203,\219\169\152\254\155\236\203\168\247W\"d";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
