...
(* OASIS_START *)
(* DO NOT EDIT (digest: 690a933a6896e9f791c4669497b3d3e9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "https://github.com/dominicjprice/sociaml-facebook-api";
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "sociaml_facebook_api_endpoints";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_tiny_json_conv", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "sociaml_facebook_api";
                      lib_findlib_name = Some "endpoints";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "sociaml_facebook_api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "sociaml_facebook_api_endpoints";
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "sociaml_facebook_api";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("core_kernel", None);
                           InternalLibrary "sociaml_facebook_api";
                           InternalLibrary "sociaml_facebook_api_endpoints"
                        ];
                      bs_build_tools =
                        [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/sociaml-facebook-api";
                      doc_title = "sociaml-facebook-api Reference";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/sociaml-facebook-api.git";
                      src_repo_browser =
                        Some
                          "https://github.com/dominicjprice/sociaml-facebook-api";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "xz\173\164\253\246\218\134\155\2008L\190aV\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
